...
public class PassphraseCredentialsProviderTest {
    ...
    public void testCredentials() throws Exception {
        final CredentialItem.StringType i = new CredentialItem.StringType(
                "enter passphrase", true);
        final CredentialItem i2 = new CredentialItem.InformationalMessage(
                "info");
        final PassphraseCredentialsProvider provider = new PassphraseCredentialsProvider(
                "passphrase");
