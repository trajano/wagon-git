...
public class GitUriTest {
    ...
    public void testBasicGitUri() throws Exception {
        ...
        final GitUri gitUri = new GitWagon().buildGitUri(URI.create("ssh://github.com/trajano/trajano.git?gh-pages#/"));
        assertEquals("gh-pages", gitUri.getBranchName());
        assertEquals("ssh://github.com/trajano/trajano.git", gitUri.getGitRepositoryUri());
    ...
    public void testBasicGitUriResolve() throws Exception {
        ...
        final GitUri gitUri = new GitWagon().buildGitUri(URI.create("ssh://github.com/trajano/trajano.git?gh-pages#/"));
        final GitUri resolved = gitUri.resolve("../coding-standards.git%3Fgh-pages%23");
        assertNotNull(resolved.getBranchName());
        assertEquals("gh-pages", resolved.getBranchName());
        assertEquals("ssh://github.com/trajano/coding-standards.git", resolved.getGitRepositoryUri());
        assertEquals("/", gitUri.getResource());
    }
    ...
    public void testBasicGitUriResolve2() throws Exception {
        ...
        final GitUri gitUri = new GitWagon().buildGitUri(URI.create("ssh://github.com/trajano/trajano.git?gh-pages#/"));
        final GitUri resolved = gitUri.resolve("../coding-standards.git%3Fgh-pages%23/foo");
        assertEquals("gh-pages", resolved.getBranchName());
        assertEquals("ssh://github.com/trajano/coding-standards.git", resolved.getGitRepositoryUri());
